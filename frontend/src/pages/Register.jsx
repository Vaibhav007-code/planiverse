...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create user
      // frontend/src/pages/Register.jsx (continued)
      ...
      // Set start date to July 1, 2025 (or any date you prefer)
      const startDate = new Date(2025, 6, 1).toISOString(); // Note: month is 0-indexed, so 6 = July
    ...
    >
      ...
      >
        ...
        <GoogleButton 
          ...
          whileTap={{ scale: 0.98 }}
        >
          <FaGoogle /> {googleLoading ? 'Signing up...' : 'Sign up with Google'}
        </GoogleButton>
